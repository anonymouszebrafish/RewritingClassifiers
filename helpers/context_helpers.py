...
from utils import tally, pbar, renormalize, nethook, imgviz  
from utils.classifier import load_classifier
from utils.custom_vgg import vgg16_bn, vgg16

features = {}

def reload_classifier(model_path, model_class, arch, dataset, layernum):
    
    preprocess = None
    mod = load_classifier(model=model_class, 
                            dataset=dataset,
...
def get_cov_matrix(loader, context_model, batch_size=78400, 
    ...
    CM_k = calculate_2nd_moment_custom(loader, context_model, 
...
def calculate_2nd_moment_custom(val_loader, context_model, 
